...
namespace Calculator2
{
    public class CalculatorModel
    {
        ...
        public static double ConvertHexToDecimal(string hexNumber)
        {
            return int.Parse(hexNumber, System.Globalization.NumberStyles.HexNumber);
        }

        public static string ConvertDecimalToHex(double decimalNumber)
        {
            return ((int)decimalNumber).ToString("X");
        }
    }
}